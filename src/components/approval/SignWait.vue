<template>
    ...
    <div class="container">
        ...
        <table class="table table-hover">
            ...
            <!--로그인 정보에서 받아올 부분-->
            <tr v-if="approvals[index].app_sign_id1 == login_id || approvals[index].app_sign_id2 == login_id || approvals[index].app_sign_id3 == login_id" class="table-light" v-for="(app, index) in approvals" :key="index">
