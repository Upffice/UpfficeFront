<template>
    <div class="subMenu">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <button type="button" class="btn btn-primary btn-lg" @click="getBoard">게시판 더보기</button>
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center libgclr"
                ...
                <router-link :to="{
                       name: 'DepPage',
                       params:{
                           board:board, board_name:board.board_name
                       }
                    }">
        ...
        methods: {
            ...
            getBoard(){
                http
                    ...
                    .then(response =>{
                        // if(this.dep_id==this.boards.dep_id){
                        // this.boards=response.data;
                        // }
                        this.boards=response.data;
                        console.log("보드 가져오기 " +response.data);
                    })
